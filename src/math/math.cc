...
// template float operator*(Vector<float, 2u> value, const Vector<float, 2u>
// addend);
...
// template float operator*(Vector<float, 3u> value, const Vector<float, 3u>
// addend);
...
// template float operator*(Vector<float, 4u> value, const Vector<float, 4u>
// addend);
