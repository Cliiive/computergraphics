...
template <class FLOAT_TYPE, size_t N> Vector<FLOAT_TYPE, N>::Vector(FLOAT_TYPE angle) {
...
template <class FLOAT_TYPE, size_t N>
Vector<FLOAT_TYPE, N> operator+(const Vector<FLOAT_TYPE, N> value,
                                const Vector<FLOAT_TYPE, N> addend) {
...
template <class FLOAT_TYPE, size_t N>
Vector<FLOAT_TYPE, N> operator-(const Vector<FLOAT_TYPE, N> value,
                                const Vector<FLOAT_TYPE, N> minuend) {
    Vector<FLOAT_TYPE, N> difference = value;
    difference -= minuend;
    return difference;
}

template <class FLOAT_TYPE, size_t N> FLOAT_TYPE& Vector<FLOAT_TYPE, N>::operator[](std::size_t i) {
    return vector[i];
}
