...
class Sound {
    const char* file_names[10] = {
        "../assets/sound/fire.wav",      "../assets/sound/extraShip.wav",
        "../assets/sound/bangSmall.wav", "../assets/sound/bangMedium.wav",
        "../assets/sound/bangLarge.wav", "../assets/sound/beat1.wav",
        "../assets/sound/beat2.wav",     "../assets/sound/saucerSmall.wav",
        "../assets/sound/saucerBig.wav", "../assets/sound/thrust.wav"};
    Mix_Chunk*           sounds[10];
